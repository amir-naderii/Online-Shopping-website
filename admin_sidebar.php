        ...
        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            ...
            <li>
                ...
                <ul class="collapse show nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                    <li class="w-100">
                        <a href="./add_item.php" class="nav-link px-0"> <span class="d-none d-sm-inline">Add Item</span></a>
                    </li>
                    <li>
                        <a href="./add_category.php" class="nav-link px-0"> <span class="d-none d-sm-inline">Add category</span></a>
                    </li>
                </ul>
            </li>
            <li class="nav-item">
